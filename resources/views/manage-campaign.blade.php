                        ...
                        <div class="pt-3 position-relative">
                            <div class="progress border-rounded-30 height-10">
                                <div
                                    ...
                                    aria-valuemin="0" aria-valuemax="100" style="width: {{ round($campaign->transaction->sum('amount') / ($campaign->amount) * (100), 0)}}%; max-width: 100%">
                                </div>
                            </div>
                        </div>
                        <div class="fs-20 pt-2">{{ round($campaign->transaction->sum('amount') / ($campaign->amount) * (100), 0) }}% of &#x20a6;{{ number_format($campaign->amount) }} goal</div>
